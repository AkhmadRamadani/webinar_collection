                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="image-wrapper mb-2">
                                    <img src="<?php echo $data['COVER_WEBINAR'] === null ? "styles/assets/img/400x300.jpg" : $data['COVER_WEBINAR']; ?>" style="height: 550px;" alt>
                                </div>
                                <div>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-1 mb-1" style="width: 550px; height: 20px;"><h6 class=""><?php echo date("l, F jS, Y, g:i a", strtotime($data['WAKTU_WEBINAR'])) ?></h6></div>
                                <div class="mt-1 mb-1" style="width: 550px; height: 50px;"><h3 class=""><?php echo $data['JUDUL_WEBINAR']; ?></h3></div>
                                <div class="mt-1 mb-1" style="width: 550px; height: 280px;"><p class=""><?php echo $data['DESKRIPSI_WEBINAR']; ?></p></div>
                                <div class="image-wrapper avatar mt-2 mb-4" style="width: 550px; height: 50px;">
                                    <img alt="avatar" src="styles/assets/img/90x90.jpg" class="rounded-circle" style="width: 50px; height: 50px;"/>&nbsp;&nbsp;&nbsp;<?php echo $data['NAMA']; ?>
                                </div>
