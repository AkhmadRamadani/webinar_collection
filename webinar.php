                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-content widget-content-area">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-1 mb-1" style="width: 550px; height: 20px;"><h6 class="">Event Date</h6></div>
                                <div class="mt-1 mb-1" style="width: 550px; height: 50px;"><h3 class="">Judul Webinar</h3></div>
                                <div class="mt-1 mb-1" style="width: 550px; height: 280px;"><p class="">Deskripsi webinar...</p></div>
