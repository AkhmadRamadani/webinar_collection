/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     31/03/2022 14:44:44                          */
/*==============================================================*/
...
(
   ...
   USER_ID              int(255),
   BIODATA              text,
   PENDIDIKAN           varchar(1024),
   PEKERJAAN            varchar(1024),
   FOTO_PROFILE         varchar(1024),
   BUKTI_IJAZAH         varchar(200),
...
alter table USER add constraint FK_MEMILIKI2 foreign key (MENTOR_ID)
      references USER_DETAIL (MENTOR_ID) on delete restrict on update restrict;

alter table USER_DETAIL add constraint FK_MEMILIKI foreign key (USER_ID)
      references USER (USER_ID) on delete restrict on update restrict;
